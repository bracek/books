...
public class TestOsobaProKolekce {
    ...
    public static void main(final String[] argv) throws IOException {
        ...
        a.add(new OsobaProKolekce("Karel", "Chytr�", 160, 60.));
        a.add(new OsobaProKolekce("Karel", "�tvrt�", 170, 70.));
        a.add(new OsobaProKolekce("Karel", "Ctvrt�", 180, 80.));
        a.add(new OsobaProKolekce("Josef", "�tvrt�", 190, 65.));
        a.add(new OsobaProKolekce("K�rel", "�tvrt�", 200, 90.));
        p.println(a);

        Collections.sort(a);
        p.println("Podle jm�na (p�irozen� �azen�)\n" + a);
        Collections.sort(a, OsobaProKolekce.PODLE_VYSKY);
        p.println("Podle v�ky\n" + a);
        Collections.sort(a, OsobaProKolekce.PODLE_VAHY);
        p.println("Podle v�hy\n" + a);
        Collections.sort(a, OsobaProKolekce.PODLE_JMENA);
        p.println("Podle jm�na\n" + a);
        p.flush();

        a.add(new OsobaProKolekce("Jan", "Z�porn�", 0, -5.));
    }
}
